...
<div class="jumbotron parallax-container bg-parallax bg-sorteo box-content">
   ...
   <div class="container">
       <div class="row">
           ...
           <a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-orange">Take the Tour</a>
       </div>
   </div>
</div>
END PARALLAX -->
...
<div class="jumbotron bg-white">
    <div class="container servicios">
        <div class="row">
            <div class="col-sm-12">
                <h2>Galley of the raffled house</h2>
 ...
 <div class="container"> 	
 	<br><h1 style="text-align:center">Coming soon</h1><br>
 </div>
